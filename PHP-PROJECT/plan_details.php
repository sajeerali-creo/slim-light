    ...
    <section class="py-5 bg-inner-sub-head">
        <div class="container">
            <div class="d-flex flex-column flex-lg-row justify-content-between">
                ...
                <!-- <div>
                    <div class="bredcums">
                        <a href="<?= ROOT_URL ?>">Home</a>/ <a href="<?= ROOT_URL ?>meal_plans.php">Meal Plans</a> / Shape Up
                    </div>
                </div> -->
            </div>
        </div>
                    ...
                    <div id="customCarousel" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            ...
                            <div class="carousel-indicators position-relative mt-3">
                                ...
                                <button type="button" data-bs-target="#customCarousel" data-bs-slide-to="<?php echo $index+1; ?>"
                        ...
                        <div class="row"> 
                                            ...
                                            <div>
                                                <ul class="nav nav-tabs" id="myTab1" role="tablist1">
                                                    ...
                                                    foreach ($packageGroup as $index => $item): ?>
                                                        <li class="nav-item" role="presentation" onclick="getDurationData('<?= $item['GroupCode'] ?>')">
                                                            <button class="nav-link <?= $index == 0 ? 'active' : ''; ?>" id="package-tab-<?= $item['GroupCode'] ?>" data-bs-toggle="tab" type="button">
                                                            ...
                                                            <div class="radio-group" id="durationslote">
                                                                ...
                                                                if($packagesByGroup){
                                                                    foreach ($packagesByGroup as $index => $item): 
                                                                        if ($item['IsActive']):
                                                                ?>
                                                                        <input type="radio" id="r<?php echo $index; ?>" name="duration" 
                                                                        data-package='<?php echo json_encode($item, JSON_HEX_APOS | JSON_HEX_QUOT); ?>'
                                                                        onclick="getpackageDetailBygroupCode(this)"
                                                                        value="<?php echo $item; ?>"
                                                                        class="radio-input duration-options <?php echo "group-".$item['GroupCode']; ?>" <?php if($index == 0){ echo 'checked'; } ?>>
                                                                        <label for="r<?php echo $index; ?>" class="radio-label"><?php echo $item['DurationDays']; ?> days</label>
                                ...
                                <div class="col-lg-4">
                                    <div class="plan-detail-card p-5">
                                        <h4 class="d-flex text-white mb-4" id="packagename"><?php echo $package_details['PackageName']; ?></h4>
                                        <div class="d-flex flex-column gap-3 text-white">
                                            ...
                                            <hr>
                                            <?php } ?>
                                            <div>Plan Duration: <span id="package-duration"><?php  echo $package_details['DurationDays']; ?></span> Days</div>
                                            <hr>
                                             <?php
                                                $subscriptionData = [];
                                                $subParamData = [
                                            ...
                                            <div class="d-flex justify-content-between opacity-50">
                                                ...
                                                <strong>AED <span id="package-unit-rate"><?php  echo $package_details['UnitRate']; ?><span></strong>
                                            </div>
                                            <?php 
                                            $coolerBagtitle = '';
                                            $coolerBagAmount = '';
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="hidden" name="selectedPackageID" id="selectedPackageID" value="<?php  echo $package_details['PackageId']; ?>">
                                            <input type="hidden" name="selectedGroup" id="selectedGroup" value="<?php  echo $package_details['GroupCode']; ?>">
                                                <a href="<?= ROOT_URL.'meal_plans.php' ?>" class="btn-link">Back</a>
                                                <div class="d-flex light-bg">
                                                    <button type="button" name="appointmentsubmit"  id="subscriptionbtn" class="subscriptionbtn btn-fancy w-100 w-lg-auto" value="appointmentform"><span>
                                                        Submit & Next</span>
