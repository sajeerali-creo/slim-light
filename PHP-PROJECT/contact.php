    ...
    <section class="py-5 bg-inner-sub-head">
        <div class="container">
            <div class="d-flex flex-column flex-lg-row justify-content-between">
                ...
                <!-- <div>
                    <div class="bredcums">
                        <a href="<?= ROOT_URL ?>">Home</a>/ Contact Us
                    </div>
                </div> -->
            </div>
        </div>
    ...
    <section class="padding-bottom padding-top">
        <div class="container">
            <div class="row justify-content-between">
                    ...
                    <form method="POST" id="contactForm">
                        ...
                        <div class="row contact-form">
                            <div class="col-lg-6 mb-4">
                                ...
                                <input type="text" name="FirstName" class="form-control w-100" id="FirstName" placeholder="Enter First Name" value="<?= $FirstName ?? '' ?>">
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <input type="text" name="LastName" class="form-control w-100" id="lastname" placeholder="Enter Last Name" value="<?= $LastName ?? '' ?>">
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <input type="text" name="EmailId" class="form-control w-100" id="EmailId" placeholder="name@example.com" value="<?= $EmailId ?? '' ?>">
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <input type="text" name="MobileNumber" class="form-control w-100" id="MobileNumber" placeholder="Enter Phone" value="<?= $MobileNumber ?? '' ?>">
                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <textarea class="min-height form-control" name="Message" id="Message"><?= $Message ?? '' ?></textarea>
                ...
                <div class="col-lg-6">
                    <img src="img/contact-img.webp" class="w-100 mb-4 mb-lg-0" alt="">
                </div>
                <div class="row">
                    <div class="col-lg-12 mb-4">
                        <h4>Locations</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="box-border">
                            ...
                            <div class="map">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d649484.5144062917!2d53.739454689062484!3d24.458185999999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e66072b263307%3A0xbdeaaad4b24e4804!2sADNOC%20Service%20Station%20%7C%20Souq%20Al%20Bateen%20(969)!5e1!3m2!1sen!2sin!4v1755008524635!5m2!1sen!2sin" width="100%" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="box-border">
                            ...
                            <div class="map">
                               <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5084.507517689781!2d55.66057867643064!3d24.198462371425553!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e8aae220160a509%3A0x5c4a072a3d6389a8!2s402%20Al%20Dirasah%20St%20-%20&#39;Asharij%20-%20Bida%20Bin%20Ammar%20-%20Abu%20Dhabi%20-%20United%20Arab%20Emirates!5e1!3m2!1sen!2sin!4v1755008602058!5m2!1sen!2sin" width="100%" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="box-border">
                            ...
                            <div class="map">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5044.721914142285!2d55.243095076449094!3d25.17755053249413!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6b08e07467bb%3A0xd7ffd0197e6cb1f9!2sMedcare%20Management%20Office!5e1!3m2!1sen!2sin!4v1755008663217!5m2!1sen!2sin" width="100%" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
