...
?>
      ...
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-indicators">
            ...
            for($i=0;$i<$row_count;$i++){  
              ...
              <button type="button" data-bs-target="#myCarousel" data-bs-slide-to="<?php echo $i; ?>" class="<?php echo $active; ?>"></button>
             <?php } ?>
              ...
              <div class="carousel-item <?php echo $active; ?>">
                  ...
                  <div class="carousel-caption">
                      ...
                      <div class="d-flex justify-content-center mt-3 dark-bg">
                          <a href="<?php echo $result['button_url'] != '' ? $result['button_url'] : '#'; ?>" class="btn-fancy">
  ...
  <!-- ===========HOWITWORKS=========== -->
  <section class="padding-bottom padding-top bg-howitworks">
  ...
  <section class="padding-bottom padding-top bg-shade-1">
      <div class="container mb-5">
          <div class="d-flex justify-content-between align-items-center">
              <h2 class="h2">Signature Dishes</h2>
          </div>
      </div>
  ...
  <section class="padding-bottom padding-top bg-stories">
      ...
      <div id="cardCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
              <div class="story-slide">
                <?php while($result=mysqli_fetch_array($query)){ ?>
                  <div class="card"><img src="<?php echo ADMIN_URL.$result['file_path'];?>" class="card-img-top" alt="..."></div>
                  <?php } ?>
              </div>
          </div>
      </div>
...
?>
  <section class="padding-bottom padding-top bg-client">
      <div class="container text-center mb-5">
          <h2 class="h2">corporate clients</h2>
      </div>
      <div class="container">
          <div class="client-logo-slider">
            <?php while($result=mysqli_fetch_array($query)){ ?>
              <div class="box-logo d-flex justify-content-center align-items-center"><img src="<?php echo ADMIN_URL.$result['file_path'];?>" alt="Client Logo"></div>
            <?php } ?>
