				...
				<div class="row" class="details">
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label for="" class="control-label">Client's Name</label>
							<input name="message_from" type="text" class="form-control" value="<?php echo isset($message_from) ? $message_from : '' ?>">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input name="business_name" type="text" class="form-control" value="<?php echo isset($business_name) ? $business_name : '' ?>">
						</div>
					</div>
				</div>
				<div class="row">
				...
				success:function(resp){
					if(resp != undefined){
						if(resp.status == 'success'){
							location.href=_base_url_+"?page=testimonials";
						}else{
