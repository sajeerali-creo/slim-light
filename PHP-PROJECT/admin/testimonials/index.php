	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-primary new_testimonial" href="javascript:void(0)"><i class="fa fa-plus"></i>&nbsp;Add New</a>
			</div>
		</div>
		<div class="card-body">
				...
				<table class="table tabe-hover table-bordered table-compact" id="list">
					...
					<tbody>
						...
						<tr>
							...
							<td><b class=""><?php echo ucwords($row['business_name']) ?></b></td>
...
<script>
	...
	$(document).ready(function(){
		$('.new_testimonial').click(function(){
			location.href = _base_url_+"?page=testimonials/manage";
		})
		$('.manage_testimonial').click(function(){
			location.href = _base_url_+"?page=testimonials/manage&id="+$(this).attr('data-id')
		})
