...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Signin Banner Image</label>
				<div class="custom-file">
			...
			<div class="form-group">
				<label for="" class="control-label">Sigup Banner Image</label>
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile" name="sign_up_img_banner" onchange="displayImg3(this,$(this))">
	              <label class="custom-file-label" for="sign_up_img_banner">Choose file</label>
	            </div>
			</div>
			<div class="form-group d-flex justify-content-center">
				<img src="<?php echo validate_image($_settings->info('banner2')) ?>" alt="" id="cimg3" class="img-fluid img-thumbnail">
			</div>
