	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-primary new_service" href="javascript:void(0)"><i class="fa fa-plus"></i>&nbsp;Add New</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	...
	$(document).ready(function(){
		$('.new_service').click(function(){
			location.href = _base_url_+"?page=services/manage";
		})
		$('.manage_service').click(function(){
			location.href = _base_url_+"?page=services/manage&id="+$(this).attr('data-id')
		})
